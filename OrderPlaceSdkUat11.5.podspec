...
s.homepage = "https://github.com/AigensTechnology/OrderPlaceSdkUat11.5"
s.license = { :type => 'MIT', :file => 'LICENSE' }
s.author = { "风筝" => "13286953452@126.com" }

s.source = { :git => "https://github.com/AigensTechnology/OrderPlaceSdkUat11.5.git", :tag => "#{s.version}" }
...
ali.libraries = 'z', 'c++'
ali.dependency 'OrderPlaceSdkUat11.5/Core'
end
...
wechat.dependency 'OrderPlaceSdkUat11.5/Core'
end
...
sa.dependency 'OrderPlaceSdkUat11.5/Core'
end
